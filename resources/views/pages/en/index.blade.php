      ...
      <div class="col-md-6 col-lg-3 ftco-animate">
        <div class="staff">
          ...
          <div class="text pt-3 text-center">
            <a href="/en-product"><h3>{{ $product->en_name}}</h3></a>
            <span class="position mb-2">{{str_limit(strip_tags($product->en_description) , $limit =20 , $end ='...')}}</span>
          </div>
        </div>
      </div>
  @endforeach
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-3 ftco-animate">
        <div class="staff">
          ...
          <div class="text pt-3 text-center">
          <a href = "/en-team" ><h3>{{$team->en_name}}</h3></a>
              ...
              <div class="testimony-wrap">
                <div class="text bg-light p-4">
                  ...
                  @if(strLen(strip_tags($new->en_details)) > 100)
                   <a href="/en-news/{{$new->id}}" style ="font-size: 11px; color:#333;"> Red more </a>
                  @endif
                <p class="name">{{$new->en_title}}</p>
                  <span class="position">{{ Carbon\Carbon::parse($new->created_at)->format('M , j , Y')}}</span>
                </div>
