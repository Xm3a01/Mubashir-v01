...
<section class="hero-wrap hero-wrap-2" style="background-image: url('images/map.png');" data-stellar-background-ratio="0.5">
  ...
  <section class="ftco-section ftco-no-pt ftco-no-pb contact-section">
          ...
          <form action="{{route('contacts.store')}}" method="POST">
            ...
            <div class="form-group">
              <textarea name="msg" id="" cols="30" rows="7" class="form-control" placeholder="Message" value="{{old('msg')}}" onkeyup = "countChar(this)"></textarea>
